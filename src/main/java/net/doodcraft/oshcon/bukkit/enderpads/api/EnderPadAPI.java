...
public class EnderPadAPI
{
    ...
    /**
     * Checks if the provided block is the center of an EnderPad, then validate and return the final EnderPad object.
     * It will only return the EnderPad object if it is both valid and already saved.
     * Therefore this is the quickest and safest method to get a full EnderPad object without directly using the database.
     *
     * @param block         the Block being checked
     * @return              a valid EnderPad object
     *                      it will return null if the EnderPad is not valid and saved
     */
